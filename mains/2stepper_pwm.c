...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */
	...
	tim2_Config(); // für PWM auf Pins 
	tim6_Config(); // für nextStep
	//-------config fertig
  ...
  setFrequency(250);
	...
	*/
	...
	/*move((Coord) {100,0}); stift(0);move((Coord) {0,0}); stift(1);
	move((Coord) {100,100}); stift(0);move((Coord) {0,0}); stift(1);
	move((Coord) {0,100}); stift(0);move((Coord) {0,0}); stift(1);
	move((Coord) {-100,100}); stift(0);move((Coord) {0,0}); stift(1);
	move((Coord) {-100,0}); stift(0);move((Coord) {0,0}); stift(1);
	move((Coord) {-100,-100}); stift(0);move((Coord) {0,0}); stift(1);
	move((Coord) {0,-100}); stift(0);move((Coord) {0,0}); stift(1);
	...
	/*stift(0);
	move((Coord) {100,0}); stift(1);move((Coord) {0,0}); stift(0);
	move((Coord) {100,100}); stift(1);move((Coord) {0,0}); stift(0);
	move((Coord) {0,100}); stift(1);move((Coord) {0,0}); stift(0);
	move((Coord) {-100,100}); stift(1);move((Coord) {0,0}); stift(0);
	move((Coord) {-100,0}); stift(1);move((Coord) {0,0}); stift(0);
	move((Coord) {-100,-100}); stift(1);move((Coord) {0,0}); stift(0);
	move((Coord) {0,-100}); stift(1);move((Coord) {0,0}); stift(0);
