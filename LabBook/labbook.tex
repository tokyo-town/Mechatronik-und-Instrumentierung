...
\tabelle{htb}{Mechatronische Komponenten der Geräte}{tab:components}{l | l}{
    \textbf{Drucker} & Stepper Motor 1 (Vorschub) \\
    & Stepper Motor 2 (Druckkopf) \\
    & Stepper Motor 3 (Scanner) \\
    & Lautsprecher \\
...
Der zweite Motor hat 4 Anschlüsse, mit denen die Drehrichtung und die Schrittfolge gesteuert werden.
...
\tabelle{htb}{Motor 2}{tab:motor2}{l l}{
    Anschlüsse \\
    \hline
    \hline
}
